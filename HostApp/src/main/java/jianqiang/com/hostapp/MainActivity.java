...
public class MainActivity extends Activity {
    ...
    public void startActivityInPlugin1(View view) {
        try {
            PluginItem item = PluginManager.plugins.get(0);
            Intent intent = new Intent();
            String activityName = item.packageInfo.packageName + ".TestActivity1";
            intent.setComponent(new ComponentName(item.packageInfo.packageName, activityName));
